...
export default function Home() {
  return (
    ...
    >
<source src="/WashMe Car Wash Video - Edited.mp4" type="video/mp4" />
</video>
<div className="absolute -bottom-[20px] w-[30rem] h-[410px] left-4 right-4 hover:bg-black/20 transition-all bg-gradient-to-tr rounded-none from-black/40 to-transparent backdrop-blur-sm px-10 py-14 text-white">
