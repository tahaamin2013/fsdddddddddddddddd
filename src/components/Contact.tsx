         ...
         <div className="flex sm:flex-row flex-col sm:gap-7 gap-0 w-full">
            ...
            <div className="mb-6 w-full">
              ...
              <input
                ...
                value={formData.name}
                required
                className={`dark:dark:bg-[#f3f3f3] border border-[#33353F] placeholder-[#9CA2A9] dark:placeholder-[#474444] text-sm rounded-lg block w-full p-2.5 ${
          ...
          <div className="mb-6">
            ...
            <textarea
              ...
              cols={2}
              rows={5}
              className={`resize-none dark:bg-[#f3f3f3] border border-[#33353F] placeholder-[#9CA2A9] dark:placeholder-[#474444] dark:text-sm rounded-lg block w-full p-2.5 ${
