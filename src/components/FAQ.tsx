...
const FAQ = () => {
  return (
   ...
   <h1 className='font-bold text-2xl text-center'>Got Questions? We’ve Got Answers!</h1>
        <Accordion type="single" collapsible className='grid grid-cols-1 text-left gap-x-8 w-full'>
          <AccordionItem className='border-b-zinc-800' value="item-1">
            <AccordionTrigger className="!text-left">1. How do I pay and renew my membership?</AccordionTrigger>
            <AccordionContent>
            You can conveniently pay and renew through our app.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem className='border-b-zinc-800' value="item-2">
            <AccordionTrigger className="!text-left">2. How do you verify my identity?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem className='border-b-zinc-800' value="item-3">
            <AccordionTrigger className="!text-left">3. Can I use the membership with another car?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem className='border-b-zinc-800' value="item-4">
            <AccordionTrigger className="!text-left">4. Can a family member use the membership?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem className='border-b-zinc-800' value="item-5">
            <AccordionTrigger className="!text-left">5. Do I need an appointment?</AccordionTrigger>
            <AccordionContent>
          ...
          <AccordionItem className='border-b-zinc-800' value="item-6">
            <AccordionTrigger className="!text-left">6. Do you accept Apple Pay?</AccordionTrigger>
            <AccordionContent>
            Yes, we accept both Apple Pay and Google Pay.
            </AccordionContent>
          </AccordionItem>
          <AccordionItem className='border-b-zinc-800 !text-left' value="item-7">
            <AccordionTrigger className="!text-left">7. Does the membership work for self-service bays?</AccordionTrigger>
            <AccordionContent>
